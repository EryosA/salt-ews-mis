...
//List the most recent 100 records registered by Wang
$result = mysqli_query($mysqli, "SELECT * FROM `rental_pool_registration_records` WHERE `Updater` LIKE 'Wang' ORDER BY `DateTime` DESC LIMIT 100 "); // using mysqli_query instead
?>

<html>
<head>	
	<title>Recorded by Wang</title>
</head>

<body>
	<h3>Recorded by Wang</h3>
