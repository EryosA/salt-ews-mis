...
//List the most recent 100 records registered by Chen
$result = mysqli_query($mysqli, "SELECT * FROM `rental_pool_registration_records` WHERE `Updater` LIKE 'Chen' ORDER BY `DateTime` DESC LIMIT 100 "); // using mysqli_query instead
?>

<html>
<head>	
	<title>Recorded by Chen</title>
</head>
