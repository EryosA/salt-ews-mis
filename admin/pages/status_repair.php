...
//List all equipment that are Repair for hire
$result = mysqli_query($mysqli, "SELECT * FROM `rental_pool_status_history` WHERE `STATUS` LIKE 'Repair' ORDER BY `DateTime` DESC "); // using mysqli_query instead
?>
